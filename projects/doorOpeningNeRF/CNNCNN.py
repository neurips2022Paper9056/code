    ...
    def trainEpoch(self, epoch):
        ...
        for b, bD in enumerate(self.trainLoader):
            ...
            if self.C['global']:
                ...
                z = self.objectEncoder(I=I, M=M[:,:,[0,2]], KT=KT)  # B, nM, k
            ...
            if self.C['lossOnSmallObjects'] > 0.0:
                ...
                M_R_smallObjects = enlargeMasks(M_R_smallObjects.unsqueeze(1), 9) # B, 1, H, W
                M_R_smallObjects = M_R_smallObjects.expand(-1, 3, -1, -1) # B, 3, H, W
                l = target[M_R_smallObjects] - rgb[M_R_smallObjects]
                if l.numel():
...
if __name__ == "__main__":
    cnncnn = CNNCNN(dataPath="data/1", expPath="exp/ConvAutoencoder-global", lossOnSmallObjects=1.0)
