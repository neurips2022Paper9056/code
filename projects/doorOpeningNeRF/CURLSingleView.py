...
class ConPre:
    ...
    def computeLoss(self, bD):
        ...
        if self.multipleLatentVectors:
            M = bD['M'][:, self.C['viewIndex'], [0,2]].to(self.device)  # B, nM, H, W
...
if __name__ == "__main__":
    conPre = ConPre(dataPath="data/1", expPath="exp/CURL", max_nM_duringTraining=1, imageEncoderNetwork='ConvImageEncoder_1', fcDim=8512)
