...
struct Transformation {
  ...
  Transformation& addRelativeRotationDeg(double degree, double x, double y, double z);
  Transformation& addRelativeRotationRad(double rad, double x, double y, double z);
