...
struct Mesh : GLDrawer {
  ...
  void setImplicitSurface(double* data, double xLo, double xHi, double yLo, double yHi, double zLo, double zHi, uint res);
  void setImplicitSurface(double* data, double xLo, double xHi, double yLo, double yHi, double zLo, double zHi, uint resX, uint resY, uint resZ);
