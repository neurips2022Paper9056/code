...
//    gl->camera.X.set(ARR(1.72801, 1.05035, 2.71986, 0.428814, 0.180159, 0.328337, 0.822105));
    gl->camera.X.set(ARR(0.248263, 0.699734, 8.11697, 0.00297557, 0.017225, 0.0490118, 0.998645));
//    gl->camera.X.set(ARR(0.342007, 9.47774, 4.93544, 0.00876403, 0.0141761, 0.555125, 0.8316));
//    gl->camera.X.set(ARR(0.232095, 8.14944, 7.2422, 0.00775987, 0.00877391, 0.442674, 0.896606));
    gl->add(*this);
    gl->width = 800;
    gl->height = 800;
  }
