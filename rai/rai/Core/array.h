...
extern floatA& NoFloatA; //this is a pointer to nullptr!!!! I use it for optional arguments
...
typedef std::function<void(arr& y, arr& J, const arr& x, int ind)> VectorFunctionWithInd;
